...
file_dir='/home/lmihhwg/logs/TA_CELLTRACE'
results_dir='./results'
translators="./translators"
Final_file="Final.log"
Network_Results="Network_Results.log"
...
function group_bins {
	...
	awk    '$2 >= 0 && $2 <= 1000 { print $1, $2, "AA_0-->1000"}
			...
			$2 >= 12500 && $2 <= 13000 { print $1, $2, "AY_12500-->12500"}
			...
			$2 >= 25000 { print $1, $2, "BF_25000-->UPWARDS"}
			END {}' $Final_file |\
